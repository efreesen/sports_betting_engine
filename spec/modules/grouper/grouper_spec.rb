...
describe Grouper do
  ...
  context "teams" do
    ...
    it "prevents teams with the same name" do
      ...
      subject.flag_url.should == other_team.flag_url
    end

    it "update an existing team" do
      other_team_name = "Test"
      other_flag_url  = "http://non_existent.com"
      other_team      = Grouper.update_team(subject.id, :name => other_team_name, :flag_url => other_flag_url)
